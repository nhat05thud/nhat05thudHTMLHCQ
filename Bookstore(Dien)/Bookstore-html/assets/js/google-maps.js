...
//Thay dia chi web
var endAddress = "10.746626,106.612287";
//Thay toa do
var lat = 10.746626, long = 106.612287;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h4>CÔNG TY TNHH ACARE VIỆT NAM</h4>' +
            '<p><span class="fa fa-map-marker"></span>Số 18 Đường 17, KP6, KDC Rạch Chiếc, P. Phước Long B, Q.9</p>' +            '<p><span class="fa fa-phone"></span>(08) 6280 5457</p>' +           '<p><span class="fa fa-envelope"></span>Email: <a href="mailto:info@acare.com.vn">info@acare.com.vn</p>' +
       '</div>';
