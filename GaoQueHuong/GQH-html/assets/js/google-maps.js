...
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        // Creating the content  
            ...
            '<h1>CTY CP CNTT TRẦN LÊ</h1>' + '<ul>' +
            '<li class="local">Địa chỉ: 111 Tên Lửa, P. Bình Trị Đông, Q.Bình Tân, Tp.HCM</li>' +            '<li class="phone">Hotline: 08 6260 1272</li>' +
            '<li class="web">Website: <a href="http://www.gaoquehuong.com">www.gaoquehuong.com</a></li>' +
            '<li class="mail">Email: <a href="mailto:info@gaoquehuong.com">info@gaoquehuong.com</a></li>' + '</ul>'
        '</div>';
